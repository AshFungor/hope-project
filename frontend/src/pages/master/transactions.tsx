        ...
        <Box sx={{ maxWidth: 500, mx: 'auto', mt: 4 }}>
            ...
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <AccordionDetails>
                    <TextField
                        ...
                        fullWidth helperText="Номер банковского счета"
                        sx={{ mb: 3 }}
                    />
                    <TextField
                        label="Количество"
                        ...
                        fullWidth helperText="Сколько надиков списать"
                        sx={{ mb: 3 }}
                    />
                    <Button variant="contained" fullWidth onClick={() => handleMoney('remove')}>Подтверждаю</Button>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <AccordionDetails>
                    ...
                    <TextField
                        ...
                        fullWidth helperText="Сколько надиков добавить"
                        sx={{ mb: 3 }}
                    />
                    <Button variant="contained" fullWidth onClick={() => handleMoney('add')}>Подтверждаю</Button>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                <AccordionDetails>
                    ...
                    />
                    <Autocomplete
                        freeSolo options={products} inputValue={removeProductName}
                        onInputChange={(_, newValue) => setRemoveProductName(newValue)}
                        renderInput={(params) => (
                            <TextField {...params} label="Название продукта" helperText="Название существующего продукта" fullWidth sx={{ mb: 3 }} />
                        )}
                    />
                    <TextField
                        label="Количество"
                        ...
                        fullWidth helperText="Сколько списать"
                        sx={{ mb: 3 }}
                    />
                    <TextField
                        label="Стоимость"
                        ...
                        fullWidth helperText="Сумма, если есть"
                        sx={{ mb: 3 }}
                    />
                    <Button variant="contained" fullWidth onClick={() => handleProduct('remove')}>Подтверждаю</Button>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                ...
                <AccordionDetails>
                    ...
                    />
                    <Autocomplete
                        freeSolo options={products} inputValue={addProductName}
                        onInputChange={(_, newValue) => setAddProductName(newValue)}
                        renderInput={(params) => (
                            <TextField {...params} label="Название товара" helperText="Название существующего товара" fullWidth sx={{ mb: 3 }} />
                        )}
                    />
                    <TextField
                        label="Количество"
                        ...
                        fullWidth helperText="Сколько добавить"
                        sx={{ mb: 3 }}
                    />
                    <TextField
                        label="Стоимость"
                        ...
                        sx={{ mb: 3 }}
                    />
                    <Button variant="contained" fullWidth onClick={() => handleProduct('add')}>Подтверждаю</Button>
                </AccordionDetails>
            </Accordion>
        </Box>
    );
