...
const TransactionHistory: React.FC = () => {
	...
	useEffect(() => {
		...
		(async () => {
			...
			const response = await Hope.send(Request.create({ viewTransactionHistory: viewReq }));
			setTransactions(response.viewTransactionHistory?.transactions ?? []);
		})();
	}, [accountId]);
