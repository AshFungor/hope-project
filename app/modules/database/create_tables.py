...
class TablesCreator:
    ...
    def create_prefectures(self, prefectures):
    ...
    def create_all_start_tables(self, prefectures, cities, users):
        self.create_prefectures(prefectures)
        self.create_cities(cities)
