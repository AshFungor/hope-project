...
def new_transaction():
    ...
    products = (
        ...
        .join(models.Product2BankAccount, models.Product.id == models.Product2BankAccount.product_id)
        .filter(models.Product2BankAccount.bank_account_id == user_id)
        .all()
    )
...
def parse_new_money_transaction():
    mapper = {"seller-account": "customer_account", "bank_account_id": "seller_account", "amount": "amount"}
